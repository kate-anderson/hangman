...
public class Utilities {
	...
	/**
	 * add the letter in the array if the letter appear more than one time, it will
	 * be add to the array list
	 * 
	 * @param w
	 * @param c
	 * @return
	...
	/**
	 * draw the hangman if the guess letter is wrong
	 * @param n
	 */
	...
	/**
	 * draw the letter when the guess letter is right
	 * @param posList
	 * @param c
	 */
